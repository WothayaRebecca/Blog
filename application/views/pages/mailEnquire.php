 ...
 <div class="col-md-8" style="padding-top: 10px">
    ...
    <div class="panel panel-heading">Enter Email Address</div>
     ...
     <div class="alert alert-info" role="alert">
        ...
        <form action = "send_password" name="login_form"  method = 'post' style="padding-top: 10px; padding-left: 200px;">          
          ...
          <input id="txtinput" style="margin-left: 50px" class="btn btn-info" style="color: RoyalBlue" type="submit"  name="submit" value="Submit"/>
