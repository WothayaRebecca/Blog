 ...
 <div class="row">
    <div id="row2" class="col-md-8">
      ...
      <form action = "register" method = 'post'>
          <label style="margin-left: 300px" for="email"><b> Email Address</b> </label>
          ...
          <input id="txtinput" type="input" name="user_type" style="margin-left: 30px" br><br/>
          <input id="txtinput" style="margin-left: 375px" class="btn btn-default" type="submit"  name="submit" value="Register"/>
