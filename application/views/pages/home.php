  ...
  <div id="row2" class="col-md-4" >
    ...
    <div id="row2" class="col-md-8">
      ...
      <form action = "register" method = 'post' name="register_form" onsubmit="return validate_register_form();">
          ...
          <label style="margin-left: 100px" for="username"><b> Name</b> </label>
          <input id="txtinput" type="input" name="username" style="margin-left: 56px"></br>
          ...
          <input id="txtinput buttonAnimate" style="margin-left: 280px;" class="btn btn-default" type="submit"  name="submit" value="Register"/>
